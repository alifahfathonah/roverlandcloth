...
/** MySQL database name */
define( 'DB_NAME', 'idnjmfgi_depong' ); // Diisi nama database

/** MySQL database username */
define( 'DB_USER', 'idnjmfgi_depong' ); // Diisi username MySQL

/** MySQL database password */
define( 'DB_PASSWORD', 'j17n01r94170194' ); // Diisi username MySQL
