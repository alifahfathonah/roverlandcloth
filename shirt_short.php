...
// TEMPLATE CONTROL
$ui_register_page = 'shirt_short';




// LOAD HEADER
loadAssetsHead('Shirt Short ');
	...
	<div class="content_top">
	 ...
	 //Load Testimony
			...
			<div class="col-md-9 content_right">
				<h4 class="head"><span class="m_2">Shirt</span> Short</h4>
				
				<div class="top_grid2">	    
					<?php
					$sql="SELECT * FROM product where kd_categories='KT013'";
