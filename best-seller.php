...
// TEMPLATE CONTROL
$ui_register_page = 'best-seller';




// LOAD HEADER
loadAssetsHead('Best Seller ');
	...
	<div class="content_top">
	 ...
	 //Load Testimony
			...
			<div class="col-md-9 content_right">
				<h4 class="head"><span class="m_2">Best</span> Seller</h4>
				
				<div class="top_grid2">	    
					<?php
					$sql="SELECT * FROM product where dibeli>0 order by rand()";
