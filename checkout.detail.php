...
// TEMPLATE CONTROL
$ui_register_page = 'checkout.detail';
...
loadAssetsHead('Detail Pemesanan');
    ...
    <div class="panel-body">
      <table class="table table-striped ">
        ...
        <tbody>
          ...
          <form role="form" method="post" enctype="multipart/form-data" action="actionorderhistory?act=hapus" >
          <tr>
                    
                      <td><input type="hidden" name="id_pemesanan" value="<?php echo $kode;?>"> </td>
                      <td></td>
                      <td><button type="submit" class="acount-btn "><i class="fa fa-close">  Batalkan / Hapus</i></button></td>
