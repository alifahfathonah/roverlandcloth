...
// TEMPLATE CONTROL
$ui_register_page = 'new-artikel';

// LOAD HEADER
loadAssetsHead('New Artikel');
	...
	<div class="content_top">
	 ...
	 //Load Testimony
			...
			<div class="col-md-9 content_right">
				<h4 class="head"><span class="m_2">New </span> Artikel</h4>
				...
				<div class="top_grid2">	    
					...
					$bln=date('m');
					 ...
					 $thn=date("Y");
					$sql="SELECT * FROM product where month(tgl)=$bln AND year(tgl)=$thn order by RAND()";
